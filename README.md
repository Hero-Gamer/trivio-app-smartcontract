...
## 🚀 Market Validation & Why It Matters
...
If I win, or if there will be further funding available, I'd look to develop this idea further:

Priority 1:
* work towards mobile first app
* add embedded wallet 

Priority 2:
* add more Stacks and Bitcoin content
* add more Stacks projects specific content such as Bitflow
* add more questions to each non-web3 category
* add localization / support multiple languages such as Spanish and Korean, perhaps more
* add more onchain smart contract functionalities
